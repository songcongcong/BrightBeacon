package com.yizutiyu.brightbeacon.sqlite;
...
//            Cursor cursor = database.query(true,table, columns, selection, selectionArgs, groupBy, having, orderBy);
            Cursor cursor = database.query(true, table, columns, selection, selectionArgs, groupBy, having, orderBy, null);
            return cursor;
        }
    }
